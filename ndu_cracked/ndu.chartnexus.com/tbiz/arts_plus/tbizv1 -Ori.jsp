...
<!-- Modal -->
<div class="modal" id="myLoginModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document" style="width: 300px;">
    <div class="modal-content">
      <div class="modal-body" id="login_content">
      	...
      	<div class="d-flex row">
            <div class="col">
           <input type="text" id="uname" class="form-control form-control-sm" placeholder="Account Login" style="margin-top:10px;">
            </div>
        </div>
        <div class="d-flex row">
            <div class="col">
            <input type="password" id="upwd" class="form-control form-control-sm" placeholder="Password" style="margin-top:10px;">
            </div>
        </div>
      	<div class="d-flex row">
            <div class="col">
			  <div class="abc-checkbox abc-checkbox-primary">
					<input class="form-check-input remember_me" name="remember_me" type="checkbox" checked="" id="remember_me">
					<label class="form-check-label nu_content4 remember_me_label" style="padding-top: 3px;" for="remember_me"> Remember me
					</label> 
				</div>
            </div>
             <div class="col">
			  	<a id="cnx-pixel-cnx" onclick="forgetPassword()" class="nu_content4 forgetPasswordLink">Forget Password</a>
            </div>
        </div>
        <div class="d-flex row">
            <div class="col" style="font-size:12px;font-weight: bold;height:20px;display:none" id="login_msg">
            </div>
        </div>
      	<button onclick='ajaxLogin()' type="button" class="btn btn-nucnx btn-signin">Sign In</button>    
      </div>
    </div>
  </div>
</div>
