/* Tabulator v5.5.0 (c) Oliver Folkerd 2023 */ ! function(e, t) {
    ...
    class n extends e {
        ...
        mapDefinitions() {
            ...
            if (e)
                for (let t in e) void 0 === this.definition[t] && (this.definition[t] = e[t]);
    ...
    class p extends e {
        ...
        updateData(e) {
            var t, i = this.element && r.elVisible(this.element),
                s = {};
    ...
    class m extends l {
        ...
        renderRows() {
            ...
            this.rows().forEach(((e, s) => {
                this.styleRow(e, s), e.initialize(!0), "group" !== e.type && (t = !1), i.appendChild(e.getElement())
            })), e.appendChild(i), e.style.minWidth = t ? this.table.columnManager.getWidth() + "px" : ""
        }
        rerenderRows(e) {
    ...
    class g extends l {
        ...
        _virtualRenderFill(e, t, i) {
            ...
            if (g && r.elVisible(this.elementVertical)) {
                for (this.vDomTop = e, this.vDomBottom = e - 1, C || this.table.options.maxHeight ? (y && (w = E / y + this.vDomWindowBuffer / y), w = Math.max(this.vDomWindowMinTotalRows, Math.ceil(w))) : w = g;
                    (w == g || h <= E + this.vDomWindowBuffer || v < this.vDomWindowMinTotalRows) && this.vDomBottom < g - 1;) {
                    for (f = [], o = document.createDocumentFragment(), p = 0; p < w && this.vDomBottom < g - 1;) s = m[b = this.vDomBottom + 1], this.styleRow(s, b), s.initialize(), s.heightInitialized || this.table.options.rowHeight || s.clearCellHeight(), o.appendChild(s.getElement()), f.push(s), this.vDomBottom++, p++;
                    if (!f.length) break;
    ...
    class b extends e {
        ...
        addRowActual(e, t, i, s) {
            var o, n, r = e instanceof p ? e : new p(e || {}, this),
        ...
        adjustTableSize() {
            let e, t = this.element.clientHeight,
                i = !1;
    ...
    class C extends e {
        ...
        load(e, t, i, s, o, n) {
            ...
            return this.dispatchExternal("dataLoading", e), !e || 0 != e.indexOf("{") && 0 != e.indexOf("[") || (e = JSON.parse(e)), this.confirm("data-loading", [e, t, i, o]) ? (this.loading = !0, o || this.alertLoader(), t = this.chain("data-params", [e, i, o], t || {}, t || {}), t = this.mapParams(t, this.table.options.dataSendParams), this.chain("data-load", [e, t, i, o], !1, Promise.resolve([])).then((e => {
        ...
        static lookupTable(e, t) {
            ...
            if ("string" == typeof e) {
                if ((i = document.querySelectorAll(e)).length)
                    for (var n = 0; n < i.length; n++)(s = x.matchElement(i[n])) && o.push(s)
    ...
    var K = {
        ...
        xlsx: function(t, i, s) {
            ...
            if (l.type = "binary", n.SheetNames = [], n.Sheets = {}, i.sheetOnly) s(h());
                ...
                if (i.sheets)
                    for (var d in i.sheets) !0 === i.sheets[d] ? (n.SheetNames.push(d), n.Sheets[d] = h()) : (n.SheetNames.push(d), r.commsSend(i.sheets[d], "download", "intercept", {
                        type: "xlsx",
                        options: {
                            sheetOnly: !0
                        },
    ...
    class ie extends k {
        ...
        headersToExportRows(e) {
            ...
            function o(e, s) {
                var n = i - s;
                if (void 0 === t[s] && (t[s] = []), e.height = e.subGroups ? 1 : n - e.depth + 1, t[s].push(e), e.height > 1)
                    for (let i = 1; i < e.height; i++) void 0 === t[s + i] && (t[s + i] = []), t[s + i].push(!1);
                if (e.width > 1)
        ...
        generateRowElement(e, t, i) {
            ...
            if (s.classList.add("tabulator-print-table-row"), e.columns.forEach(((o, n) => {
                    if (o) {
                        var r, a = document.createElement("td"),
    ...
    class oe extends k {
        ...
        initializeColumn(e, t) {
            ...
            e.modules.filter = {
                success: function(t) {
                    var o, n = "input" == e.modules.filter.tagType && "text" == e.modules.filter.attrType || "textarea" == e.modules.filter.tagType ? "partial" : "match",
                        r = "",
                        a = "";
    ...
    var ne = {
        ...
        money: function(e, t, i) {
            var s, o, n, r, a, l = parseFloat(e.getValue()),
                h = "",
                d = t.decimal || ".",
                c = t.thousand || ",",
                u = t.negativeSign || "-",
            ...
            if (l < 0 && (l = Math.abs(l), h = u), s = !1 !== g ? l.toFixed(g) : l, o = (s = String(s).split("."))[0], n = s.length > 1 ? d + s[1] : "", !1 !== t.thousand)
        ...
        datetime: function(e, t, i) {
            var s, o = window.DateTime || luxon.DateTime,
        ...
        traffic: function(e, t, i) {
            var s, o, n = this.sanitizeHTML(e.getValue()) || 0,
                r = document.createElement("span"),
                a = t && t.max ? t.max : 100,
                l = t && t.min ? t.min : 0,
        ...
        progress: function(e, t = {}, i) {
            var o, n, r, a, l, h = this.sanitizeHTML(e.getValue()) || 0,
                d = e.getElement(),
                c = t.max ? t.max : 100,
                u = t.min ? t.min : 0,
        ...
        configureGroupSetup() {
            if (this.table.options.groupBy) {
                ...
                if (this.allowedValues = this.table.options.groupValues, Array.isArray(e) && Array.isArray(i) && e.length > i.length && console.warn("Error creating group headers, groupHeader array is shorter than groupBy array"), this.headerGenerator = [function() {
                    ...
                    })), this.groupIDLookups = [], e) this.table.modExists("columnCalcs") && "table" != this.table.options.columnCalcs && "both" != this.table.options.columnCalcs && this.table.modules.columnCalcs.removeCalcs();
    ...
    class we extends k {
        ...
        bindTouchEvents(e) {
            var t, i, s, o, n, r, a = e.getElement(),
                l = !1;
        ...
        moveHover(e) {
            var t, i = this.table.columnManager.getContentsElement(),
                s = i.scrollLeft,
    ...
    class De extends k {
        ...
        watchData(e) {
            ...
            this.currentVersion++, t = this.currentVersion, this.unwatchData(), this.data = e, this.origFuncs.push = e.push, Object.defineProperty(this.data, "push", {
                ...
                configurable: !0,
                value: function() {
                    var s, o, n = Array.from(arguments),
    ...
    class Se extends k {
        ...
        _mouseDown(e, t, i) {
            ...
            function o(e) {
                var i, o, n = void 0 === e.screenX ? e.touches[0].screenX : e.screenX,
                    r = n - s.startX,
                    a = n - s.latestX;
    ...
    class Fe extends k {
        ...
        formatCollapsedData(e) {
            var t = document.createElement("table");
            return e.forEach((function(e) {
                var i, s = document.createElement("tr"),
                    o = document.createElement("td"),
    ...
    class He extends k {
        ...
        childRowSelection(e, t) {
            ...
            if (t)
                for (let e of i) this._selectRow(e, !0);
            else
                for (let e of i) this._deselectRow(e, !0)
        }
    }
    ...
    class _e extends k {
        ...
        findSorter(e) {
            var t, i = this.table.rowManager.activeRows[0],
                s = "string";
