/*! @license DOMPurify 3.2.3 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/3.2.3/LICENSE */ ! function(e, t) {
    ...
    var ne = function t() {
        ...
        let we = Object.seal(l(null, {
            ...
            je = {},
            Xe = null;
        const qe = N({}, ["annotation-xml", "audio", "colgroup", "desc", "foreignobject", "head", "iframe", "math", "mi", "mn", "mo", "ms", "mtext", "noembed", "noframes", "noscript", "plaintext", "script", "style", "svg", "template", "thead", "title", "video", "xmp"]);
        let $e = null;
        const Ke = N({}, ["audio", "video", "img", "source", "image", "track"]);
        let Ve = null;
        const Ze = N({}, ["alt", "class", "for", "id", "label", "name", "pattern", "placeholder", "role", "summary", "title", "value", "style", "xmlns"]),
        ...
        const Nt = function(e) {
                ...
                }(e) ? (Tt(e), !0) : "noscript" !== n && "noembed" !== n && "noframes" !== n || !A(/<\/no(script|embed|frames)/i, e.innerHTML) ? (Me && e.nodeType === Z && (t = e.textContent, u([fe, de, he], (e => {
                    t = g(t, e, " ")
        ...
        return o.sanitize = function(e) {
            ...
            if (Ue || dt(t), o.removed = [], "string" == typeof e && (Ye = !1), Ye) {
                if (e.nodeName) {
                    ...
                    if (!Se[t] || Oe[t]) throw _("root node is forbidden and cannot be sanitized in-place")
                }
